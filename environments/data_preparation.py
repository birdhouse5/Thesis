...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Create VariBAD dataset")
    parser.add_argument('--output', type=str, default="data/sp500_rl_ready_cleaned.parquet",
                       help='Output file path')
    parser.add_argument('--force', action='store_true',
                       help='Force recreate even if file exists')
    parser.add_argument('--info', action='store_true',
                       help='Show dataset info only')
    ...
    if args.info:
        ...
        if info.get('exists'):
            if 'error' in info:
                ...
                print(f"   Tickers: {info['tickers']['count']}")
